        ...
        <li className="book-list__item">
            <div className="book-list__item__inner">
                ...
                <div className="book-list__item__inner__info">
                    ...
                    <a href="#" className="book-list__item__inner__info__comment__link" onClick={()=>{setShowReview(prevShowReview => !prevShowReview)}}>
            ...
            <CSSTransition in={showReview} timeout={200} classNames="review">
                <div className="review">
                    ...
                    <form className="review__form js-form">
                        <textarea className="review__form__input" rows={5} placeholder={`「${book.title} 」を読んだ感想・評価を教えてください`} onChange={(event) => setComment(event.currentTarget.value)} value={comment}></textarea>
